...
codesandboxUrl="https://codesandbox.io/embed/github/wuchuhengdemo/note-demo-nestjs-impl/tree/master/?fontsize=14&hidenavigation=1&initialpath=%2Fgraphql&theme=dark" >
    <iframe src='https://notedemo.wuchuheng.com/api' style={{width: '100%', height: '50vh'}}></iframe>
</BrowserWindow>
:::
...
isJump
codesandboxUrl="https://codesandbox.io/embed/github/wuchuhengdemo/note-demo-nestjs-impl/tree/master/?fontsize=14&hidenavigation=1&initialpath=%2Fgraphql&theme=dark" >
    <iframe src='https://notedemo.wuchuheng.com/graphql' style={{width: '100%', height: '50vh'}}></iframe>
</BrowserWindow>
<Tabs>
  <TabItem value="query" label="Query示例" default>
    <img src="https://qiniu.wuchuheng.com/images/note-graphql20211118022512.png" />
  </TabItem>
  <TabItem value="mutation" label="Mutation示例">
    <img src="https://qiniu.wuchuheng.com/images/graphql-notes20211118023352.png" />
  </TabItem>
  <TabItem value="subscription" label="Subscription示例">
    <img src="https://qiniu.wuchuheng.com/images/graphql-note20211118033049.png" />
  </TabItem>
</Tabs>
```
:::
