...
| `Gradl` | ✅ | `Gradle 7.5` | 包的生成初始化生成和包的发布都是需要这个工具来完成 |
...
> 注册
<LightBox url="https://qiniu.wuchuheng.com/images/WX20221115-130426.png" alt="Gradle发布Java库到mvnrepository" />

> 登录
<LightBox url="https://qiniu.wuchuheng.com/images/howToPublishJavaLiberyToMvn1.png" alt="Gradle发布Java库到mvnrepository" />

> 新手向导
<LightBox url="https://qiniu.wuchuheng.com/images/howToPublishJavaLiberyToMvn2.png" alt="Gradle发布Java库到mvnrepository" />
...
<LightBox url="https://qiniu.wuchuheng.com/images/https-%3A%3Aqiniu.wuchuheng.com%3Aimages%3AhowToPublishJavaLiberyToMvn3.png" alt="Gradle发布Java库到mvnrepository" />

> 填写Issue表单

<LightBox url="https://qiniu.wuchuheng.com/images/howToCreateAJavaLiberyAndPublishToMvn2.png" alt="Gradle发布Java库到mvnrepository" />
<LightBox url="https://qiniu.wuchuheng.com/images/howToCreateAJavaLiberyAndPublishToMvn4.png" alt="Gradle发布Java库到mvnrepository" />

> Issue 创建成功

<LightBox url="https://qiniu.wuchuheng.com/images/howToCreateAJavaLiberyAndPublishToMvn5.png" alt="Gradle发布Java库到mvnrepository" />
</details>
...
<LightBox url="https://qiniu.wuchuheng.com/images/howToCreateAJavaLiberyAndPublishToMvn6.png" alt="Gradle发布Java库到mvnrepository" width={40}/>
...
<details>
    ...
    <LightBox url="https://qiniu.wuchuheng.com/images/howToCreateAJavaLiberyAndPublishToMvn7.png" alt="Gradle发布Java库到mvnrepository" />
</details>


### 3.5 回复Issue并告知对方Txt记录已添加

<LightBox url="https://qiniu.wuchuheng.com/images/howToCreateAJavaLiberyAndPublishToMvn8.png" alt="Gradle发布Java库到mvnrepository" width={40} />

> 然后等待对方回复.也许几分钟吧. 😂😂😂

### 3.6 完成仓库的发包许可
<LightBox url="https://qiniu.wuchuheng.com/images/howToCreateAJavaLiberyAndPublishToMvn9.png" alt="Gradle发布Java库到mvnrepository" width={40} />
...
<details>
    ...
    <LightBox url="https://qiniu.wuchuheng.com/howToPublishJavaLiberyToMvn11.png" alt="Gradle发布Java库到mvnrepository" width={40}/>
</details>
...
是的，它让我们把包上传到这个[s01.oss.sonatype.org](https://s01.oss.sonatype.org/), 我们已经做了;而同样的这个链接也正是仓库的后台，
使用我们的之前注册的账号(wuchuhengcn)就能使用上去，查看我们刚才上传的包了
