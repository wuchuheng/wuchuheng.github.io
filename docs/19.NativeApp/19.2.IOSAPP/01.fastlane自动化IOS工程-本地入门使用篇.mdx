---
title: 01 fastlane自动化IOS工程(一)-本地入门使用篇
...
<Img src='storage:///WX20230103-164852%402x.png' />
<Img src='storage:///WX20230103-165058%402x.png' />
<Img src='storage:///images/Screen%20Shot%202023-01-03%20at%2016.55.50.png' />
<Img src='storage:///images/WX20230103-165827%402x.png' />
<Img src='storage:///images/WX20230103-170130%402x.png' />
<Img src='storage:///images/WX20230103-170130%402x.png' />
...
<details>
    ...
    <Img src="storage:///images/WX20230103-214143.png" />
    <Img src="storage:///images/WX20230103-214503.png" />
</details>
...
<details>
    ...
    <Img src="storage:///images/WX20230103-104553%402x.png" />
    <Img src="storage:///images/Screen%20Shot%202023-01-04%20at%2009.26.02.png" />
    <Img src="storage:///images/WX20230103-105256%402x.png" />
...
<Img src='storage:///images/Screen%20Shot%202023-01-03%20at%2016.30.30.png' />
<Img src='storage:///images/WX20230103-163556%402x.png' />
<Img src='storage:///images/WX20230103-163755%402x.png' />
</details>
...
<Img src="storage:///images/WX20230103-215009.png" />
<Img src="storage:///images/WX20230103-215123.png" />
并上传我们的CRS文件
<Img src="storage:///images/WX20230103-215411.png" />
<Img src="storage:///images/WX20230103-215632.png" />
...
开发用的profile文件在本地开发时，起到了说明证书(certificates)和本地应用(identifiers)之间的匹配关系。从而才能使用本地私钥对应用进行开发和调试。
    ...
    <Img src='storage:///images/WX20230103-220814.png' />
    <Img src='storage:///images/WX20230103-220951.png' />
    <Img src='storage:///images/Screen%20Shot%202023-01-03%20at%2022.11.09.png' />
    <Img src='storage:///images/WX20230103-221309.png' />
    <Img src='storage:///images/WX20230103-221445.png' />
    <Img src='storage:///images/WX20230103-221553.png' />
</details>
...
<details>
    ...
    <Img src="storage:///images/Screen%20Shot%202023-01-04%20at%2009.11.02.png" />
</details>
...
<Img src="storage:///images/WX20230105-080308%402x.png" />
</details>
...
<details>
    ...
    <Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2008.06.22.png" />
</details>
    
<details>
    <summary>step 3: 在xcode项目中选择发布</summary>
    
    <Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2008.08.09.png" />
</details>
        
<details>
    <summary>step 4: 在xcode项目中选择下一步</summary>
    
    <Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2008.09.18.png" />
</details>
...
<details>
    ...
    <Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2008.10.13.png" />
</details>
...
<details>
    ...
    <Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2008.12.03.png" />
</details>

<details>
<summary>step 7: 在xcode项目中选择确定上传</summary>

<Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2008.15.12.png" />
</details>

<details> 
<summary>step 8: 上传失败了，报错了</summary>
<Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2008.21.02.png" />
</details>
...
<Img src="storage:///images/WX20230105-094116%402x.png" />
</details>

<details>
<summary>step 10: 然后再把上面的步骤再来一次, 重新上传应用</summary>
<Img src="storage:///images/Screen%20Shot%202023-01-05%20at%2009.53.32.png" />
</details>
    
好到了这一步，就说明了手动在xcode进行应用打包和上传已经没有问题了。在`testFlight`也已经能看看我们上传的应用了。

<Img src='storage:///images/Screen%20Shot%202023-01-05%20at%2009.56.17.png' />
...
<Img src='storage:///images/WX20230106-061958%402x.png' />
